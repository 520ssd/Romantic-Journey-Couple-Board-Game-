...
export const BOARD_TILES = [
  ...
  { id: 3, type: 'heart', bgClass: 'bg-blue-100' },
  { id: 4, type: 'heart', bgClass: 'bg-pink-100' },
  { id: 5, type: 'haert', bgClass: 'bg-purple-100' },
  { id: 6, type: 'heart', bgClass: 'bg-pink-100' },
  { id: 7, type: 'heart', bgClass: 'bg-blue-100' },
  { id: 8, type: 'coin', bgClass: 'bg-emerald-100' },
  { id: 9, type: 'heart', bgClass: 'bg-amber-100' },
  { id: 10, type: 'heart', bgClass: 'bg-emerald-100' },
  { id: 11, type: 'heart', bgClass: 'bg-blue-100' },
  { id: 12, type: 'heart', bgClass: 'bg-pink-100' },
  { id: 13, type: 'heart', bgClass: 'bg-emerald-100' },
  { id: 14, type: 'heart', bgClass: 'bg-pink-100' },
  { id: 15, type: 'haert', bgClass: 'bg-purple-100' },
  { id: 16, type: 'coin', bgClass: 'bg-emerald-100' },
  { id: 17, type: 'heart', bgClass: 'bg-pink-100' },
  { id: 18, type: 'heart', bgClass: 'bg-emerald-100' },
  { id: 19, type: 'heart', bgClass: 'bg-blue-100' },
  { id: 20, type: 'heart', bgClass: 'bg-pink-100' },
  { id: 21, type: 'heart', bgClass: 'bg-emerald-100' },
  { id: 22, type: 'heart', bgClass: 'bg-amber-100' },
  { id: 23, type: 'heart', bgClass: 'bg-blue-100' },
  { id: 24, type: 'coin', bgClass: 'bg-emerald-100' },
  { id: 25, type: 'heart', bgClass: 'bg-pink-100' },
  { id: 26, type: 'heart', bgClass: 'bg-emerald-100' },
  { id: 27, type: 'heart', bgClass: 'bg-blue-100' },
  { id: 28, type: 'haert', bgClass: 'bg-purple-100' },
  { id: 29, type: 'heart', bgClass: 'bg-emerald-100' },
